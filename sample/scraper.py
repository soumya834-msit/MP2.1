...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 12 16:38:29 2020
...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 12 10:01:50 2020
...
def get_faculty_bio_info(faculty_url):
    ...
    #print(faculty_name)
        ...
        people_bio_segment = ''.join(people_bio_segment.strip('	\n\t'))
        people_bio_segment = re.sub('\s+',' ',people_bio_segment)
